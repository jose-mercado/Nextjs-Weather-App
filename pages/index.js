  ...
  if(loading) {
    ...
    return (
      <div>
        ...
        {/* background image */}
        <Image src='https://images.unsplash.com/photo-1592210454359-9043f067919b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80' 
        layout='fill'
        className='object-cover'
        />
  
        {/* Search */}
        <div className='relative flex justify-beyween items-center max-w-[500px] w-full m-auto pt-4 text-white z-10'>
